...
const LAB_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    name: "Smashzone",
    tag: "Padel / Web3",
    desc: "Play padel, earn crypto. SmashZone validates real matches combining court geolocation + health data (Health Connect / Apple Health) and rewards every verified game with $SMASH tokens. Season 0 live.",
    metric: { label: "TOKEN", value: "$SMASH", trend: "Season 0 Active" },
    status: "LIVE",
    color: "electric",
    span: "med",
    href: "https://smashzone.app",
    image: "/assets/smashzone/smashzone0.png",
    stack: ["Next.js", "TypeScript", "BSC", "HealthKit"],
  },
  {
    id: "motorland",
    name: "Motorland.io",
    tag: "Gaming / Cyberpunk",
    desc: "Infinite-track cyberpunk racing game. 4 difficulty tiers, 4 unique ships, procedurally generated circuits — built for players who want speed without limits.",
    metric: { label: "CIRCUITS", value: "∞", trend: "4 SHIPS · 4 MODES" },
    status: "LIVE",
    color: "amber",
    span: "med",
